<?php
/******************************************************************/
/* Title........: 'corePHP' - Mortgage Calculator
/* Description..: Figure your mortgage
/* Author.......: Steven Pignataro
/* Version......: For Joomla! 1.0.x Stable ONLY
/* Created......: 09/20/06
/* Contact......: steven@corephp.com
/* Copyright....: (C) 2006 Steven Pignataro, 'corePHP' Development. All rights reserved.
/* License......: Commercial
/******************************************************************/
###################################################################
//Copyright (C) 2006 Steven Pignataro, 'corePHP' Development. 

// Dont allow direct linking
defined( '_JEXEC' ) or die( 'Direct Access to this location is not allowed. [ <a href="http://www.corephp.com">\'corePHP\' Component for Joomla! 1.0.x Latest Stable</a> ]' );
...
@import "<?php echo JURI::base(); ?>/components/com_mortgage/mortgage.css";
...
<form method="POST" id="information" name="information" action="<?php echo JURI::base(); ?>/index.php?option=com_mortgage&Itemid=<?php echo $Itemid;?>">
<input type="hidden" name="form_complete" value="1">
    ...
    <legend><strong>Purchase &amp; Financing Information</strong></legend>
		...
		<?php if ($form_complete) { print("<a href=\"index.php?option=com_mortgage\"><br />Start Over</a><br />"); } ?><br />
	</fieldset>
...
<!-- Table of Amortization -->
		...
		<script src="<?php echo JURI::base(); ?>components/com_mortgage/jquery.js" type="text/javascript"></script>	
		<script type="text/javascript">
		jQuery.noConflict();
		
		jQuery(document).ready(function() { 
             jQuery('div.display> div').hide(); 
             jQuery('div.display> h3').click(function() { 
...
<?php
        ...
        echo "<div class=\"display\"> <!-- start outer //-->";
        echo "<h3 class=\"clickme\">Year $current_year</h3>";
		echo "<div> <!-- start inner //-->";
        ...
        while ($current_month <= $month_term) {        
            ...
            if ($show_legend) {
				...
				echo '</div> <!-- end inner //-->';
				$now = $current_year + 1;
				echo "<h3 class=\"clickme\">Year $now </h3>";
				echo "<div> <!-- start inner //-->";
